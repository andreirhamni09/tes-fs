    ...
    <div class="sidebar sidebar-dark sidebar-fixed" id="sidebar">
        ...
        <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
            <ul class="nav-group-items">
                ...
                <li class="nav-item"><a class="nav-link active" id="add" href="{{ url('/tambahbaru') }}">Add New</a></li>
        ...
        <header class="header header-sticky mb-4">
            <div class="container-fluid">
                ...
                <ul class="header-nav d-none d-md-flex">
                    <li class="nav-item"><a class="nav-link" href="{{ url('/tambahbaru') }}">Add New</a></li>
                </ul>
                        ...
                        <div class="card mb-4">
                            <div class="card-header"><strong>Add New</strong></div>                            
                                <div class="card-body">                            
                                    <div class="example">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="title" class="form-control" id="title" placeholder="Judul Artikel">
                                        </div>
                                        <div class="mb-3">
                                            <label for="exampleFormControlTextarea1" class="form-label">Content</label>
                                            <textarea class="form-control" name="content" id="content" rows="3" placeholder="Tulis Kontent"></textarea>
                                        </div>
                                        <div class="mb-3">
                                            <label for="exampleFormControlInput1" class="form-label">Category</label>
                                            <input type="text" name="category" class="form-control" id="category" placeholder="Kategory">
                                        </div>
                                        ...
                                        <select name="status" id="status" class="form-select" aria-label="Default select example">
                                            ...
                                            @php
                                                $arr_status = array("publish", "draft", "thrash");
                                            @endphp
                                ...
                                <div class="card-footer">
                                    <button class="btn btn-primary" onclick="tambah()" type="button">Update</button>
                                </div>
                        </div>
                    </div>
                    <!-- /.col-->
        ...
        function tambah()
        {
            ...
            $.ajax({
                ...
                success: function(data) {
                    if(data == "Artikel Berhasil Ditambahkan")
                    {
                        alert(data);
